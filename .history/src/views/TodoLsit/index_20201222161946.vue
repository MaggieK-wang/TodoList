<template>
  <div class="Todo">
    <div class="Todo-input">
     ...
     <div class="Todo-list">
         <el-checkbox-group 
          v-model="checkbox":class="{'change-color': isActive}" >
          <el-checkbox @change="checkboxed(item.name)" v-for="(item,index) in TodoList" :label="item.name" :key="item.id"><span>{{item.name}}</span></el-checkbox>
         </el-checkbox-group>
      </div>
