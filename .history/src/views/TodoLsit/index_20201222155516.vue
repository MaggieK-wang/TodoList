<template>
  <div class="Todo">
    <div class="Todo-input">
     ...
     <div class="Todo-list">
         <el-checkbox-group 
          v-model="checkbox" :class="changeStyle" @change="checkboxed">
          <el-checkbox v-for="(item,index) in TodoList" :label="item.name" :key="item.name"><span>{{item.name}}</span></el-checkbox>
         </el-checkbox-group>
      </div>
  ...
  del(){
    ...
    if(this.checkbox){
      console.log(this.checkbox);
       this.TodoList.splice(this.checkbox,this.checkbox.length);
    }
  },
  // 全部计划
  all(){
