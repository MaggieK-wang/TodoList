...
data(){
  return{
    ...
    filters:{
      ...
      active: TodoList => TodoList.filter(todo => (todo.task_status='0')),
      completed:TodoList => TodoList.filter(todo => (todo.task_status='1'))
    },
  }
},
mounted(){ 
...
computed:{
  ...mapActions([
    ...
    filteredTodoList(){
      ...
      console.log(this.filters[this.visibility](this.TodoList));
    },
